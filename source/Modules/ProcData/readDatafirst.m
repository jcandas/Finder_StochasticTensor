function [Datas, parameters] = readDatafirst(parameters, methods)
...
Datas.rawdata.T = T;
Datas.rawdata.AData = fliplr(AData); %Datas.rawdata.AData = AData;
Datas.rawdata.BData = fliplr(BData);

%====================splitfirst======================
if parameters.multilevel.splitfirst == 1
    NA = size(Datas.rawdata.BData,2);
