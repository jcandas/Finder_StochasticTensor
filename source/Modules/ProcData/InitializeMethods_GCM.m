function [methods] = InitializeMethods_GCM()
...
% not used for the results in paper 'Stochastic Tensor Space Feature Theory With Applications To Rubust Machine Learning'
...
methods.Multi2.ChooseTruncations = @MethodOfEllipsoids_18; 
